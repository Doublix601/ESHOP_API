 ...
 */
final class Version20210306222102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, nb_ventes INT NOT NULL, label VARCHAR(30) NOT NULL, brand VARCHAR(25) NOT NULL, ht_price DOUBLE PRECISION NOT NULL, description VARCHAR(10000) NOT NULL, tva INT NOT NULL, ecotax DOUBLE PRECISION NOT NULL, delivery_option VARCHAR(50) NOT NULL, delivery_price INT NOT NULL, discount INT NOT NULL, stock INT NOT NULL, img VARCHAR(255) NOT NULL, ttc_price DOUBLE PRECISION NOT NULL, description_courte VARCHAR(100) NOT NULL, INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_line DROP FOREIGN KEY FK_9CE58EE1E00EE68D');
